...
SELECT
    ...
    NULLIF("fastestLapSpeed", '\N')::decimal AS "fastestLapSpeed",
    "statusId",
...
SELECT
    ...
    COUNT(*) FILTER (WHERE grid_change > 0) AS luot_nguoc_dong,
    COUNT(*) FILTER (WHERE grid_change < 0 ) AS luot_tut_hang,
